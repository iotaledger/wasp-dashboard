...
export class CorecontractsApi extends runtime.BaseAPI {
    ...
    async accountsGetAccountBalanceRaw(requestParameters: AccountsGetAccountBalanceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AssetsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts/account/{agentID}/balance`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"agentID"}}`, encodeURIComponent(String(requestParameters.agentID))),
            method: 'GET',
    ...
    async accountsGetAccountNFTIDsRaw(requestParameters: AccountsGetAccountNFTIDsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AccountNFTsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts/account/{agentID}/nfts`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"agentID"}}`, encodeURIComponent(String(requestParameters.agentID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async accountsGetAccountNonceRaw(requestParameters: AccountsGetAccountNonceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AccountNonceResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts/account/{agentID}/nonce`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"agentID"}}`, encodeURIComponent(String(requestParameters.agentID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async accountsGetAccountsRaw(requestParameters: AccountsGetAccountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AccountListResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async accountsGetFoundryOutputRaw(requestParameters: AccountsGetFoundryOutputRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FoundryOutputResponse>> {
        ...
        if (requestParameters.chainID2 === null || requestParameters.chainID2 === undefined) {
            throw new runtime.RequiredError('chainID2','Required parameter requestParameters.chainID2 was null or undefined when calling accountsGetFoundryOutput.');
        }
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts/foundry_output`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"chainID_"}}`, encodeURIComponent(String(requestParameters.chainID2))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async accountsGetNFTDataRaw(requestParameters: AccountsGetNFTDataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NFTDataResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts/nftdata`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"nftID"}}`, encodeURIComponent(String(requestParameters.nftID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async accountsGetNativeTokenIDRegistryRaw(requestParameters: AccountsGetNativeTokenIDRegistryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NativeTokenIDRegistryResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts/token_registry`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async accountsGetTotalAssetsRaw(requestParameters: AccountsGetTotalAssetsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AssetsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/accounts/total_assets`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blobsGetAllBlobsRaw(requestParameters: BlobsGetAllBlobsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlobListResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blobs`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blobsGetBlobInfoRaw(requestParameters: BlobsGetBlobInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlobInfoResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blobs/{blobHash}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"blobHash"}}`, encodeURIComponent(String(requestParameters.blobHash))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blobsGetBlobValueRaw(requestParameters: BlobsGetBlobValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlobValueResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blobs/{blobHash}/data/{fieldKey}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"blobHash"}}`, encodeURIComponent(String(requestParameters.blobHash))).replace(`{${"fieldKey"}}`, encodeURIComponent(String(requestParameters.fieldKey))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetBlockInfoRaw(requestParameters: BlocklogGetBlockInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockInfoResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/blocks/{blockIndex}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"blockIndex"}}`, encodeURIComponent(String(requestParameters.blockIndex))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetControlAddressesRaw(requestParameters: BlocklogGetControlAddressesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ControlAddressesResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/controladdresses`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetEventsOfBlockRaw(requestParameters: BlocklogGetEventsOfBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EventsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/events/block/{blockIndex}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"blockIndex"}}`, encodeURIComponent(String(requestParameters.blockIndex))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetEventsOfLatestBlockRaw(requestParameters: BlocklogGetEventsOfLatestBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EventsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/events/block/latest`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetEventsOfRequestRaw(requestParameters: BlocklogGetEventsOfRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EventsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/events/request/{requestID}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"requestID"}}`, encodeURIComponent(String(requestParameters.requestID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetLatestBlockInfoRaw(requestParameters: BlocklogGetLatestBlockInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockInfoResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/blocks/latest`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetRequestIDsForBlockRaw(requestParameters: BlocklogGetRequestIDsForBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestIDsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/blocks/{blockIndex}/requestids`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"blockIndex"}}`, encodeURIComponent(String(requestParameters.blockIndex))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetRequestIDsForLatestBlockRaw(requestParameters: BlocklogGetRequestIDsForLatestBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestIDsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/blocks/latest/requestids`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetRequestIsProcessedRaw(requestParameters: BlocklogGetRequestIsProcessedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestProcessedResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/requests/{requestID}/is_processed`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"requestID"}}`, encodeURIComponent(String(requestParameters.requestID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetRequestReceiptRaw(requestParameters: BlocklogGetRequestReceiptRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestReceiptResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/requests/{requestID}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"requestID"}}`, encodeURIComponent(String(requestParameters.requestID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetRequestReceiptsOfBlockRaw(requestParameters: BlocklogGetRequestReceiptsOfBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockReceiptsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/blocks/{blockIndex}/receipts`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"blockIndex"}}`, encodeURIComponent(String(requestParameters.blockIndex))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async blocklogGetRequestReceiptsOfLatestBlockRaw(requestParameters: BlocklogGetRequestReceiptsOfLatestBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockReceiptsResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/blocklog/blocks/latest/receipts`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async errorsGetErrorMessageFormatRaw(requestParameters: ErrorsGetErrorMessageFormatRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ErrorMessageFormatResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/errors/{contractHname}/message/{errorID}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"contractHname"}}`, encodeURIComponent(String(requestParameters.contractHname))).replace(`{${"errorID"}}`, encodeURIComponent(String(requestParameters.errorID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async governanceGetChainInfoRaw(requestParameters: GovernanceGetChainInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GovChainInfoResponse>> {
        ...
        const response = await this.request({
            path: `/v2/chains/{chainID}/core/governance/chaininfo`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
