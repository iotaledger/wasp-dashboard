...
export interface AdmChainChainIDAccessNodePubKeyDeleteRequest {
    chainID: string;
    pubKey: string;
}

export interface AdmChainChainIDAccessNodePubKeyPutRequest {
    chainID: string;
    pubKey: string;
}
...
export class AdminApi extends runtime.BaseAPI {
     ...
     */
    async admChainChainIDAccessNodePubKeyDeleteRaw(requestParameters: AdmChainChainIDAccessNodePubKeyDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.chainID === null || requestParameters.chainID === undefined) {
            throw new runtime.RequiredError('chainID','Required parameter requestParameters.chainID was null or undefined when calling admChainChainIDAccessNodePubKeyDelete.');
        }

        if (requestParameters.pubKey === null || requestParameters.pubKey === undefined) {
            throw new runtime.RequiredError('pubKey','Required parameter requestParameters.pubKey was null or undefined when calling admChainChainIDAccessNodePubKeyDelete.');
        }
        ...
        const response = await this.request({
            path: `/adm/chain/{chainID}/access-node/{pubKey}`.replace(`{${"chainID"}}`, encodeURIComponent(String(requestParameters.chainID))).replace(`{${"pubKey"}}`, encodeURIComponent(String(requestParameters.pubKey))),
            method: 'DELETE',
     ...
     * Remove an access node from a chain
     */
    async admChainChainIDAccessNodePubKeyDelete(requestParameters: AdmChainChainIDAccessNodePubKeyDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.admChainChainIDAccessNodePubKeyDeleteRaw(requestParameters, initOverrides);
    }

    /**
     * Add an access node to a chain
     */
    async admChainChainIDAccessNodePubKeyPutRaw(requestParameters: AdmChainChainIDAccessNodePubKeyPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.chainID === null || requestParameters.chainID === undefined) {
            throw new runtime.RequiredError('chainID','Required parameter requestParameters.chainID was null or undefined when calling admChainChainIDAccessNodePubKeyPut.');
        }

        if (requestParameters.pubKey === null || requestParameters.pubKey === undefined) {
            throw new runtime.RequiredError('pubKey','Required parameter requestParameters.pubKey was null or undefined when calling admChainChainIDAccessNodePubKeyPut.');
        }
     ...
     * Add an access node to a chain
     */
    async admChainChainIDAccessNodePubKeyPut(requestParameters: AdmChainChainIDAccessNodePubKeyPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.admChainChainIDAccessNodePubKeyPutRaw(requestParameters, initOverrides);
    }
