...
export function instanceOfL1Params(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "baseToken" in value;
    isInstance = isInstance && "maxPayloadSize" in value;
...
export function L1ParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): L1Params {
    ...
    return {
        ...
        'baseToken': BaseTokenFromJSON(json['baseToken']),
        'maxPayloadSize': json['maxPayloadSize'],
        'protocol': ProtocolParametersFromJSON(json['protocol']),
    };
}
